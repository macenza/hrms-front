...
export default function SubscriptionManagementPage() {
        ...
        const fetchSubscriptionProfile = async () => {
            try {
                ...
                if (err.response?.status === 404) {
                    ...
                    setFetchError(err.response?.data?.message || err.message || "Failed to load subscription details.");
                }
            } finally {
                setIsLoading(false);
            }
    ...
    const validUntilDate = customer ? getValidUntilDate(customer.startDate || customer.createdAt) : null;
    const basePlanPrice = customer ? getBasePlanPrice(customer.subscriptionPlan) : 0;
    const addonsTotal = customer ? (customer.addons || []).reduce((sum: number, addon: any) => sum + (addon.price || 0), 0) : 0;
    ...
    const getPlanConfig = () => {
        if (!customer) return { maxEmployees: 0, price: '', type: '', features: [] };
        ...
        if (customer.subscriptionPlan === 'Professional') {
            return {
                ...
                features: ['Core HR Directory', 'Attendance check-ins', 'Leave Management', 'Automated Disbursement Payroll', 'Asset Lifecycle tracking', 'With AI (Employees can give AI interviews)']
            };
        }
        return {
    ...
    if (!hasSubscription) {
        return (
            <main className="min-h-[calc(100vh-5rem)] bg-gray-50/30 dark:bg-gray-950/20 py-8 px-4 md:px-8">
                <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-500">
                    {/* Header */}
                    <div className="bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 p-6 md:p-8 rounded-3xl shadow-xl shadow-gray-100/50 dark:shadow-none flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative overflow-hidden">
                        <div className="absolute top-[-20%] right-[-10%] w-[30%] h-[50%] rounded-full bg-amber-500/5 blur-[80px] pointer-events-none" />
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 font-semibold leading-relaxed">
                                    Your organization is currently running on a local/dummy workspace with no active cloud subscription.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {/* Growth Plan Card */}
                            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-6 rounded-3xl shadow-md space-y-4 relative overflow-hidden flex flex-col justify-between">
                                <div className="space-y-3">
                                    <div className="flex justify-between items-start">
                                        <h3 className="text-xl font-bold text-gray-900 dark:text-white">Growth Plan</h3>
                                        <span className="px-2.5 py-0.5 text-[10px] font-bold bg-blue-50 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400 rounded-full border border-blue-100 dark:border-blue-900/30">
                                            ₹499/mo
                                        </span>
                                    </div>
                                    <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                        Perfect for fast-growing startups and small teams looking for core HR management.
                                    </p>
                                    <ul className="space-y-2 text-xs font-semibold text-gray-600 dark:text-gray-300">
                                        ...
                                        <li className="flex items-center gap-2">🟢 Comprehensive directory</li>
                                        <li className="flex items-center gap-2">🟢 Automated Leave management</li>
                                        <li className="flex items-center gap-2">🟢 Basic Payroll calculations</li>
                                    </ul>
                                </div>
                                <button className="w-full bg-[#6D5DFD] hover:bg-[#5b4eed] text-white py-3 rounded-xl font-bold text-xs transition duration-200" onClick={() => alert("Please register a subscription at our main portal to activate this feature.")}>
                                    Activate Growth Plan
                                </button>
                            </div>

                            {/* Professional Plan Card */}
                            <div className="bg-white dark:bg-gray-900 border border-[#6D5DFD]/35 dark:border-[#6D5DFD]/20 p-6 rounded-3xl shadow-md space-y-4 relative overflow-hidden flex flex-col justify-between ring-2 ring-[#6D5DFD]/10">
                                <span className="absolute -top-2.5 right-6 px-2.5 py-0.5 bg-[#6D5DFD] text-white text-[9px] font-bold uppercase tracking-wider rounded-full shadow-sm">
                                    Most Popular
                                </span>
                                <div className="space-y-3">
                                    <div className="flex justify-between items-start">
                                        <h3 className="text-xl font-bold text-gray-900 dark:text-white">Professional Plan</h3>
                                        <span className="px-2.5 py-0.5 text-[10px] font-bold bg-[#6D5DFD]/10 text-[#6D5DFD] rounded-full border border-[#6D5DFD]/20">
                                            ₹1,999/mo
                                        </span>
                                    </div>
                                    <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                        Optimized for mid-market organizations and scaling companies needing advanced tools.
                                    </p>
                                    <ul className="space-y-2 text-xs font-semibold text-gray-600 dark:text-gray-300">
                                        <li className="flex items-center gap-2">🟢 Up to 250 active employees</li>
                                        <li className="flex items-center gap-2">🟢 Leave & Attendance check-ins</li>
                                        <li className="flex items-center gap-2">🟢 Automated Disbursement Payroll</li>
                                        <li className="flex items-center gap-2">🟢 With AI (Interviews & Analytics)</li>
                                    </ul>
                                </div>
                                <button className="w-full bg-[#6D5DFD] hover:bg-[#5b4eed] text-white py-3 rounded-xl font-bold text-xs transition duration-200" onClick={() => alert("Please register a subscription at our main portal to activate this feature.")}>
        ...
        return (
            <div className="min-h-[60vh] flex items-center justify-center bg-transparent">
                <div className="text-center space-y-2">
                    ...
                    <p className="text-xs text-gray-500">Please contact support if this issue persists.</p>
                </div>
            </div>
        );
    }
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-6 md:p-8 rounded-3xl shadow-xl shadow-gray-100/50 dark:shadow-none space-y-6">
                        <div className="flex items-center gap-2 pb-4 border-b border-gray-100 dark:border-gray-800">
                            <Users className="w-5 h-5 text-[#6D5DFD]" />
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <span className="text-xs font-mono font-bold text-gray-500 dark:text-gray-400 block mt-1 bg-gray-50 dark:bg-gray-800/40 p-2 rounded-lg border border-gray-100 dark:border-gray-800/60 break-all">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <span className="text-sm font-bold text-gray-850 dark:text-gray-200 block mt-1 flex items-center gap-1">
                                        ...
                                        {calculateRemainingDays(customer.expiryDate)}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 border-t border-gray-100 dark:border-gray-800/80 pt-3">
                                ...
                                <div>
                                    ...
                                    <span className="text-xs font-bold text-gray-750 dark:text-gray-200 block mt-1">
                            ...
                            <div className="grid grid-cols-2 gap-4 border-t border-gray-100 dark:border-gray-800/80 pt-3">
                                ...
                                <div>
                                    ...
                                    <span className="text-xs font-mono font-bold text-gray-500 dark:text-gray-400 block mt-1 break-all">
                    ...
                    <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-6 md:p-8 rounded-3xl shadow-xl shadow-gray-100/50 dark:shadow-none space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <span className="text-sm font-bold text-gray-850 dark:text-gray-255 block mt-1 flex items-center gap-1.5">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                                ...
                                {totalCapacity !== Infinity && (currentCount / totalCapacity) >= 0.8 && (
                                    <div className="mt-4 p-4 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/50 rounded-2xl flex items-start gap-3 text-amber-800 dark:text-amber-300 animate-in fade-in slide-in-from-top-2 duration-300">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-xs font-medium text-amber-700 dark:text-amber-450/90 leading-relaxed">
                        ...
                        <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-6 md:p-8 rounded-3xl shadow-xl shadow-gray-100/50 dark:shadow-none space-y-6">
                            ...
                            {paymentHistory.length === 0 ? (
                                <div className="text-center py-8 text-gray-400 font-semibold space-y-2">
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full border-collapse text-left">
                                        ...
                                        <tbody className="divide-y divide-gray-55/40 dark:divide-gray-800/50 text-xs font-semibold text-gray-700 dark:text-gray-300">
                            ...
                            <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-6 md:p-8 rounded-3xl shadow-xl shadow-gray-100/50 dark:shadow-none space-y-6 sticky top-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-[#6D5DFD] hover:bg-[#5b4eed] disabled:bg-gray-100 dark:disabled:bg-gray-800 disabled:text-gray-400 dark:disabled:text-gray-500 disabled:cursor-not-allowed text-white py-4 px-5 rounded-2xl font-black flex items-center justify-center gap-1.5 transition text-sm shadow-lg shadow-blue-200 dark:shadow-none"
                                    >
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            {purchaseSuccess ? (
                                ...
                                <div className="py-12 flex flex-col items-center justify-center text-center space-y-3">
                                    ...
                                    <h4 className="text-sm font-bold text-gray-850 dark:text-gray-250">
                                        Authorizing payment...
                                    </h4>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="pt-4 border-t border-gray-100 dark:border-gray-800/80">
                                        ...
                                        <p className="text-[9px] text-gray-400 mt-3 text-center font-bold">
