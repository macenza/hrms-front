...
export default function PayrollDashboard() {
    ...
    // Pagination for History Modal table
    ...
    } = usePayrollHistory(historyPage, historyLimit);

    const finalizeMonthMutation = useFinalizeMonth();

    // Calculations detail hook
    const { data: batchRecords, isLoading: isRecordsLoading } = useBatchRecords(selectedBatchId);
    ...
    const getStatusBadge = (status: string) => {
        switch(status) {
            ...
            case 'Processing': return <Badge variant="warning" className="gap-1"><Loader2 size={14} className="animate-spin"/> Processing</Badge>;
    ...
    return (
        <div className="min-h-[calc(100vh-4rem)] bg-gray-50/50 dark:bg-[#0a0a0a] text-gray-900 dark:text-gray-100 p-6 lg:p-8 transition-colors duration-300">
            <div className="max-w-7xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                {/* Real-time Payroll Accruals Table */}
                ...
                <Modal
                    ...
                    title="Finalized Payroll Batches"
                    className="max-w-5xl"
                >
                                    ...
                                    {isHistoryLoading ? (
                                        <tr>
                                            <td colSpan={6} className="px-6 py-12 text-center text-gray-500">
                                                <Loader2 className="w-8 h-8 animate-spin mx-auto text-blue-600 dark:text-blue-500" />
                                                <span className="block mt-2 text-xs font-semibold text-gray-400">Loading batch history...</span>
                                            </td>
                                        </tr>
                                    ) : isHistoryError ? (
                                        <tr>
                                        ...
                                        <tr>
                                            <td colSpan={6} className="px-6 py-12 text-center text-gray-500 font-medium">
                                                No completed payroll batches found.
                                            </td>
                                        </tr>
                                    ) : (
                        ...
                        {historyTotal > 0 && (
                            <div className="py-2 flex items-center justify-between gap-4">
                                <div className="text-xs font-semibold text-gray-500">
                                    ...
                                    <span className="text-gray-900 dark:text-gray-100">{historyTotal}</span> batches
                                </div>
                                <div className="flex items-center gap-1.5">
                                    <Button
                                        variant="outline"
                ...
                <Modal
                    ...
                    title="Batch Calculations Preview"
                    className="max-w-5xl"
                >
                    <div className="space-y-4">
                        <div className="overflow-x-auto border border-gray-150 dark:border-gray-800 rounded-xl shadow-sm bg-white dark:bg-gray-900">
