                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <span className={`px-2.5 py-0.5 text-xs font-black rounded-full flex items-center gap-1 border ${
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <span className={`inline-block text-[10px] font-extrabold uppercase tracking-wider px-2.5 py-0.5 rounded-full border mt-1.5 ${
                                        customer.subscriptionStatus === 'Active'
                            ...
                            <div className="grid grid-cols-2 gap-4 border-t border-gray-100 dark:border-gray-800/80 pt-3">
                                ...
                                <div>
                                    <span className="text-[10px] font-black text-gray-400 uppercase tracking-wider block">Start Date</span>
                                    <span className="text-xs font-semibold text-gray-600 dark:text-gray-450 block mt-1">
                                        {formatDateOnly(customer.startDate || customer.createdAt)}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <span className="text-xs font-bold text-gray-700 dark:text-gray-300 block mt-1">
                                        {formatDateOnly(customer.expiryDate)}
                                    </span>
                                </div>
                                <div>
                                    ...
                                    <span className="text-xs font-black text-emerald-500 block mt-1">
                                        ₹{customer.amountPaid ? customer.amountPaid.toLocaleString('en-IN') : planConfig.price.replace('/mo', '')}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 border-t border-gray-100 dark:border-gray-800/80 pt-3">
                                ...
                                <div>
                                    ...
                                    <span className={`inline-block text-[10px] font-extrabold uppercase tracking-wider px-2 py-0.5 rounded-full border mt-1 ${
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-6 md:p-8 rounded-3xl shadow-xl shadow-gray-100/50 dark:shadow-none space-y-6">
                            <h2 className="text-lg font-black text-gray-900 dark:text-white tracking-tight flex items-center gap-2 border-b border-gray-100 dark:border-gray-800 pb-4">
                                <History className="w-5 h-5 text-[#6D5DFD]" /> Employee Expansion History
                            </h2>

                            {addonsWithCumulative.length === 0 ? (
                                <div className="text-center py-8 text-gray-405 font-semibold space-y-2">
                                    <Activity className="w-8 h-8 text-gray-300 mx-auto" />
                                    <p className="text-sm">No employee expansion add-ons purchased yet.</p>
                                </div>
                            ) : (
                                    ...
                                    <table className="w-full border-collapse text-left">
                                        <thead>
                                            <tr className="border-b border-gray-100 dark:border-gray-800/80 text-[10px] font-black text-gray-400 uppercase tracking-wider">
                                                ...
                                                <th className="pb-3 px-2">Add-on Item</th>
                                                <th className="pb-3 px-2 text-center">Slots</th>
                                                <th className="pb-3 px-2 text-right">Price</th>
                                                <th className="pb-3 px-2 text-center">New Capacity</th>
                                        ...
                                        <tbody className="divide-y divide-gray-50 dark:divide-gray-800/50 text-xs font-semibold text-gray-700 dark:text-gray-300">
                                            {addonsWithCumulative.map((addon: any, idx: number) => (
                                                <tr key={idx} className="hover:bg-gray-50/50 dark:hover:bg-gray-800/20">
                                                    <td className="py-3 pr-2 font-mono whitespace-nowrap">{formatDateOnly(addon.purchaseDate)}</td>
                                                    <td className="py-3 px-2 text-[#6D5DFD] dark:text-blue-400 font-extrabold">{addon.name}</td>
                                                    <td className="py-3 px-2 text-center font-bold text-gray-900 dark:text-white">+{addon.slots}</td>
                                                    <td className="py-3 px-2 text-right font-extrabold text-emerald-500">₹{addon.price}</td>
                                                    <td className="py-3 px-2 text-center font-extrabold text-gray-900 dark:text-white">{addon.cumulativeCapacity} limit</td>
                                                    <td className="py-3 pl-2 text-gray-400 font-mono max-w-[120px] truncate" title={addon.transactionId}>
                                                        {addon.transactionId}
                                                    </td>
                                                </tr>
                                            ))}
