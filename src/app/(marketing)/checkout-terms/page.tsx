                            ...
                            <div className="space-y-3">
                                ...
                                <div className="overflow-x-auto rounded-2xl border border-gray-150 dark:border-gray-900 shadow-md">
                                    <table className="w-full border-collapse text-left text-sm text-gray-500 dark:text-gray-400">
                                        <thead className="bg-gray-50 dark:bg-gray-900/60 text-gray-700 dark:text-gray-200 uppercase text-[10px] tracking-wider font-extrabold border-b border-gray-150 dark:border-gray-900">
                                            <tr>
