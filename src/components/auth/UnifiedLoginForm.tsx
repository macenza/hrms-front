...
export default function UnifiedLoginForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (role === 'admin' || role === 'hr' || role === 'employee' || role === 'manager') {
        ...
        <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 animate-in fade-in zoom-in-95 duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                    <div className="flex justify-between items-center">
                        ...
                        <Link href="/forgot-password" className="text-xs font-bold text-[#6D5DFD] dark:text-[#8B7BFF] hover:underline">
                            Forgot Password?
                        </Link>
                    </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800">
                <p className="text-center text-sm text-gray-500 dark:text-gray-400 font-medium">
                    ...
                    <Link href="/register-company" className="text-[#6D5DFD] dark:text-[#8B7BFF] font-bold hover:underline">
                        Register Company
                    </Link>
                </p>
            </div>
